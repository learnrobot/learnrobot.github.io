var links = [
    ...
    { 
        id: 406, title: "KT AI Robot (Serving, Delivery)", category: "service", source: "KT", url: "https://kt-robot.co.kr/kt-ai-robot/", country: "kr",
    ...
    { id: 6004, title: "The Searial Cleaners<br>(Marine Pollution Cleaning)", category: "Marine", source: "Poralu Marine", url: "https://searial-cleaners.com/", country: "fr", 
        description: "An expert in tackling marine pollution providing beach cleaning robots, mobile collector drones, and bubble curtains for coastal and inland waters.",         businessArea: "Coastal Waste Management & Robotics", models: ["BeBot", "Jellyfishbot", "Collec'Thor", "InvisiBubble"]  },
    // Medical
    ...
    { id: 3051, title: "Zimmer Biomet (ROSA Robotics)", category: "medical", source: "Brain & Knee Surgery", url: "https://www.zimmerbiomet.com/en", country: "us", description: "Integrating robotics, data, and AI into orthopedic procedures to improve patient outcomes in knee and brain surgeries.", businessArea: "Orthopedic Robotic Technologies", models: ["ROSA Knee", "ROSA Brain"] },
    ...
    { id: 1101, title: "URG Life Science (uLab Series)", category: "medical", source: "Lab Automation Robotics", url: "https://unitedrobotics.group/en", country: "de", description: "Automating laboratory workflows with flexible robotics to improve efficiency and reduce human error in life sciences.", businessArea: "Laboratory Automation", models: ["uLab Series"] },
    { id: 3013, title: "MEERE COMPANY (Revo-i)", category: "medical", source: "Laparoscopic Surgical Robot", url: "http://revosurgical.com/render/view/index/", country: "kr", description: "A South Korean innovator offering a cost-effective laparoscopic surgical robot system to broaden access to robotic surgery.", businessArea: "Laparoscopic Surgical Robotics", models: ["Revo-i"] },
    ...
    // Logistics
    { id: 1111, title: "Amazon Robotics<br>(Next-Gen Fulfillment)", category: "logistics", source: "Amazon Robotics", url: "https://www.amazon.science/research-areas/robotics", country: "us", description: "Operating the world's largest fleet of warehouse robots, utilizing advanced AMRs and robotic arms for end-to-end fulfillment.", businessArea: "E-commerce Fulfillment Automation", models: ["Proteus", "Sparrow", "Robin"] },
    ...
    { id: 1114, title: "Zebra Technologies<br>(Fetch Robotics)", category: "logistics", source: "Zebra", url: "https://www.zebra.com/us/en.html", country: "us", description: "Delivering a comprehensive portfolio of autonomous mobile robots optimizing material handling and inventory tracking.", businessArea: "Data-Driven Material Handling", models: ["Fetch100", "Fetch500"] },
    ...
    { id: 1012, title: "Samsung Robotics", category: "Home", source: "Samsung", url: "https://sra.samsung.com/research-area/robotics-intelligence/", country: "kr", description: "Developing advanced consumer and assistive robots including the Ballie companion robot, Bot Care, and the Bot Fit wearable.", businessArea: "Consumer & Assistive Robotics", models: ["Ballie", "Bot Care", "Bot Fit"] },
	...
	{ id: 20024, title: "American Bionics Project", category: "organization", url: "https://americanbionics.org/", country: "us", description: "A non-profit accelerating the development of revolutionary mobility technologies and bionics to make wheelchairs obsolete.", businessArea: "Bionics & Mobility Foundation", models: [] },
